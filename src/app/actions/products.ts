...
export namespace ProductsActions {
  ...
  export const receiveProductsFail = createAction(Type.RECEIVE_FAIL_PRODUCTS, (error: any) => error);
  ...
  export const addProductFail = createAction(Type.ADD_PRODUCT_FAIL, (error: any) => error);
}
